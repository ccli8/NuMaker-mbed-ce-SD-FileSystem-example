# Example for SD card (SD bus mode) backed file system on Nuvoton's Mbed CE enabled boards

This is an example to demo file system backed by
[SD card in SD bus mode](https://github.com/mbed-nuvoton/NuMaker-mbed-ce-SD-driver)
rather than SPI bus mode on Nuvoton's Mbed CE enabled boards.
...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-SD-FileSystem-example
    $ cd NuMaker-mbed-ce-SD-FileSystem-example
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-SD-FileSystem-example.bin` or `NuMaker-mbed-ce-SD-FileSystem-example.hex` onto **NuMaker-IoT-M467** board
